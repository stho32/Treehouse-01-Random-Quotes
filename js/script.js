 ...
 * 
 * As IIFE, so we do not clutter the global namespace...
 */
(function RandomQuoteSelection() {
    ...
    */
    ...
    I did not go for complete randomness to ensure that the background-colors always
    have a good contrast with the font-color.
    */
    let colors = ["red", "green", "blue", "orange"];
    let lastBackgroundColor = ""; 
    /* 
        Change the background color to something new.
    */
    ...
    */
    function getRandomQuote() {
        let possibleIndexes = getIndexesOfQuotesThatHaveNotBeenShownYet();
    ...
    */
    ...
    function AutomaticQuoteChange() {
        let changeQuoteEveryInSeconds = 30;
        let counterState = changeQuoteEveryInSeconds;
